...
{
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x0A5, .snum = 0x07, .sdpa = 0x07 },
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x0B8, .snum = 0x07, .sdpa = 0x07 },
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x06F, .snum = 0x07, .sdpa = 0x07 },
};
